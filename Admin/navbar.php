     ...
     <!--  <div class="form-inline">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="fa-solid fa-bars-progress"></i><p>&nbsp;&nbsp; Management<i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="users.php" class="nav-link"><i class="fa-solid fa-user-tie"></i><p>&nbsp;&nbsp; Examinee</p></a>
              </li>
               <li class="nav-item">
                <a href="questions.php" class="nav-link"><i class="fa-solid fa-question"></i><p>&nbsp;&nbsp; Questions</p></a>
              </li>
               <li class="nav-item">
                <a href="category.php" class="nav-link"><i class="fa-solid fa-puzzle-piece"></i><p>&nbsp;&nbsp; Category</p></a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="fa-solid fa-print"></i><p>&nbsp;&nbsp; Reports<i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="report_users.php" class="nav-link"><i class="fa-solid fa-user-tie"></i><p>&nbsp;&nbsp; List of examinee</p></a>
              </li>
               <li class="nav-item">
                <a href="results.php" class="nav-link"><i class="fa-solid fa-square-poll-vertical"></i><p>&nbsp;&nbsp; Examinee results</p></a>
              </li>
            </ul>
          </li>

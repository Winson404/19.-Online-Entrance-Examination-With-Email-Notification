          ...
          <div class="col-lg-4 mt-5">
            <div class="card card-outline card-primary">
              <div class="card-header text-center">
                <img src="images/FB_IMG_1669123021632-modified.png" alt="" class=" m-2 border-0" width="80">
                <a href="#" class="h2 text-center d-block m-auto"><b>Login</b></a>
              </div>
              <div class="card-body">
                <!-- <p class="login-box-msg">Sign in to start your session</p> -->
                <form action="processes.php" method="post" id="quickForm">
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Enter username" name="email" id="emails"  onkeydown="validations()" onkeyup="validations()" >
                  ...
                  <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="Password" id="password" name="password" minlength="6" required>
                    <div class="input-group-append">
                      <div class="input-group-text">
              ...
              <div class="error-page">
                ...
                <div class="error-content">
                  ...
                  <p>
                    ...
                    Meanwhile, you may return to <a href="index.php">login</a> page.
                  </p>

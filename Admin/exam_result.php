<title>Online Entrance Examination | Examination result</title>
<?php 
    include 'navbar.php'; include '../sweetalert_messages.php';  
    if(isset($_GET['user_Id'])) {
    $id = $_GET['user_Id'];
    $aa = mysqli_query($conn, "SELECT * FROM users WHERE user_Id='$id'");
                    ...
                    <div class="container" id="printElement">
                      ...
                      <div class="wrapper row p-3">
                        ...
                        <div class="col-sm-12 col-12 p-3" style="line-height: 10px;">
                          ...
                          <p>
                            Subject with the Lowest Grade / What Grades:&nbsp;&nbsp;<span style="text-decoration: underline;"><?php echo $row['Sub_lowestGrade']; ?></span>
                          </p>
                          <p>
                            Subject with the Highest Grade / What Grades:&nbsp;&nbsp;<span style="text-decoration: underline;"><?php echo $row['Sub_HighestGrade']; ?></span>
                          </p>
                          <p>
                            GWA:&nbsp;&nbsp;<span style="text-decoration: underline;"><?php echo $row['GWA']; ?></span>
                          </p>
                      </div>

                      <div class="col-12 p-3">
                        <p><?php echo ' '.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'].' '; ?> have <?php if($passfail >= 50) { echo '<b>Passed</b>'; } else { echo '<b>Failed</b>'; } ?> the Entrance Examination with a score of <b><?php echo $count; ?>%</b> out of 100 items.</p>
                        <hr>
                      </div>
                      ...
                      <div class="col-lg-12 p-3">
                        <table class="table table-bordered table-striped " style="border: 1px solid lightgrey;">
                          ...
                          <tbody id="users_data">
                            ...
                            <tr>
                               <td style="border: 1px solid lightgrey;">Filipino</td>
                               <td style="border: 1px solid lightgrey;"><?php echo $score['filipino']; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               <td style="border: 1px solid lightgrey;">History</td>
                               <td style="border: 1px solid lightgrey;"><?php echo $score['history']; ?></td>
                            </tr>
                          </tbody>
                          <tfoot>
                            <thead>
                        ...
                        <div class="d-flex">
                            <h5>Remarks: <?php if($passfail >= 50) { echo 'Passed!'; } else { echo 'Failed!'; } ?></h5>
                        </div>
                      </div>
                      </div>
                    </div>

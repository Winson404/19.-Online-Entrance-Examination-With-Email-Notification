<title>Online Entrance Examination | Register</title>
            ...
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                ...
                <?php 
                    ...
                    include 'homebackground.php';
                    include 'siblings.php';
                    include 'parents.php';
                    include 'contactPerson.php';
                    include 'contactPerson2.php';
                    include 'contactPerson3.php';
                    include 'membershipOrg.php';
                    include 'uniqueFeatures.php';
                ...
                <div style="overflow:auto;">
                  <div style="float:right;">
                    ...
                    <button type="submit" class="btn btn-info submit" id="submit" onclick="nextPrev(1)" name="create_user">Submit</button>
                  </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var htmlmember = '<tr><td><input type="text" class="form-control" name="orgName[]"  placeholder="Enter Organization name..."></td><td><input type="text" class="form-control" name="position[]"  placeholder="Enter Position/Title..."></td><td><button class="btn btn-danger" id="removemember"><i class="fa-solid fa-trash-can"></i></button></td></tr>';
        var x = 1;
        ...
        var htmlmemberoutside = '<tr><td><input type="text" class="form-control" name="outsideorgName[]"  placeholder="Enter Organization name..."></td><td><input type="text" class="form-control" name="outsideposition[]"  placeholder="Enter Position/Title..."></td><td><button class="btn btn-danger" id="outsideremovemember"><i class="fa-solid fa-trash-can"></i></button></td></tr>';
        var x = 1;

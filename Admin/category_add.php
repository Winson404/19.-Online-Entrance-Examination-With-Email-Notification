    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control form-control-sm"  placeholder="Category name" name="category_name" required>
        </div>
        <div class="form-group">
            <label>No. of items</label>
            <input type="number" class="form-control form-control-sm"  placeholder="No. of items" name="no_items" required>
        </div>
        <div class="form-group">
